...
Requires PyMySQL: https://pypi.python.org/pypi/PyMySQL
"""
...
try:
    ...
    raise ImproperlyConfigured(
        'Error loading pymysql module: %s.\n'
        'Did you install PyMySQL?' % e
    )

from pymysql.constants import CLIENT, FIELD_TYPE  # isort:skip
from pymysql.converters import escape_str, conversions  # isort:skip

# Some of these import pymysql, so import them after checking if it's installed.
...
def adapt_datetime_warn_on_aware_datetime(value, conv):
    ...
    return escape_str(value.strftime("%Y-%m-%d %H:%M:%S.%f"), conv)
